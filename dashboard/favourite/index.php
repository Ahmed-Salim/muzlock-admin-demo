...
<div class="container-fluid">
    <div class="row">
        <div class="col">
            <h1 class="mb-3">Favourite Users</h1>
            <table class="table">
                <thead>
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM favourite INNER JOIN user ON user.id = favourite.user_fav WHERE favourite.fav_by = $userId ORDER BY user.user_name ASC";
                    ...
                    <?php
                        ...
                        echo "<tr><td colspan='13' class='text-center text-danger'>No Favourite Users</td></tr>";
                    }
