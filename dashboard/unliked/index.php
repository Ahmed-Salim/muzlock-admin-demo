        ...
        <div class="col">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM unliked INNER JOIN user ON user.id = unliked.user_unlike WHERE unliked.unlike_by = $userId ORDER BY user.user_name ASC";
                    ...
                    ?>
                            ...
                            <tr class="align-middle text-center">
                                ...
                                <td class="text-center"><img src="<?php echo $row['user_img']; ?>" alt="<?php echo $row['user_name']; ?>" height="50px" /></td>
                    ...
                    <?php
                        ...
                        echo "<tr><td colspan='13' class='text-center text-danger'>No Unliked Users</td></tr>";
                    }
