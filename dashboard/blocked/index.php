...
<div class="container-fluid">
    <div class="row">
        <div class="col">
            <h1 class="mb-3">Blocked Users</h1>
            <table class="table">
                <thead>
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM blocked INNER JOIN user ON user.id = blocked.user_blocked WHERE blocked.block_by = $userId ORDER BY user.user_name ASC";
                    ...
                    <?php
                        ...
                        echo "<tr><td colspan='13' class='text-center text-success'>No Blocked Users</td></tr>";
                    }
